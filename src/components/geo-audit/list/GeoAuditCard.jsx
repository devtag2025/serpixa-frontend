"use client";
import { HiEye, HiTrash, HiLocationMarker, HiUsers } from "react-icons/hi";
...
/**
 * GeoAuditCard - Individual card component for mobile/tablet view
 * Displays local SEO audit information in a compact, touch-friendly card format
 * 
 * @param {Object} audit - The audit data object
 * @param {Function} onDelete - Callback function for delete action
 */
export default function GeoAuditCard({ audit, onDelete }) {
  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-3">
        ...
        <div>
          <span className="text-xs text-gray-500 uppercase tracking-wide font-medium block mb-1">
            {t("dashboard.localSeoAudit.view.location")}
          </span>
        ...
        {/* Competitors and Date Row */}
        <div className="flex items-center justify-between pt-2">
          <div>
            <span className="text-xs text-gray-500 uppercase tracking-wide font-medium block mb-1">
              {t("dashboard.localSeoAudit.view.competitors")}
            </span>
            <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center justify-end gap-2 px-4 py-3 border-t border-gray-100 bg-gray-50/50 rounded-b-xl">
        <button
          ...
          aria-label={t("dashboard.localSeoAudit.view.viewAudit")}
        >
        ...
        <button
          ...
          aria-label={t("dashboard.localSeoAudit.view.deleteAudit")}
        >
