  ...
  return (
    <div className="mb-4 sm:mb-6 bg-white rounded-lg sm:rounded-xl border border-gray-200 shadow-sm">
      <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 border-b border-gray-200">
        <h2 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900">{t("dashboard.geoAudit.view.businessInformation")}</h2>
      </div>
      <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
        {!hasData ? (
          <p className="text-sm text-gray-500 italic">{t("dashboard.geoAudit.view.noBusinessInfo") || "No business information available"}</p>
        ) : (
          ...
          {businessInfo.name && (
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">{t("dashboard.geoAudit.view.name")}</p>
          ...
          {businessInfo.address && (
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">{t("dashboard.geoAudit.view.address")}</p>
          ...
          {businessInfo.phone && (
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">{t("dashboard.geoAudit.view.phone")}</p>
          ...
          {businessInfo.website && (
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">{t("dashboard.geoAudit.view.website")}</p>
                <a
          ...
          {(businessInfo.rating !== null || businessInfo.reviews !== null) && (
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">{t("dashboard.geoAudit.view.ratingAndReviews")}</p>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {businessInfo.reviews !== null && (
                    <span className="text-xs sm:text-sm text-gray-600">
                      ({businessInfo.reviews} {t("dashboard.geoAudit.view.reviews")})
                    </span>
                  )}
                </div>
              </div>
          ...
          {businessInfo.category && (
            <div className="flex items-start gap-2 sm:gap-3">
              <HiOfficeBuilding className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 mt-0.5 flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">{t("dashboard.geoAudit.view.category")}</p>
