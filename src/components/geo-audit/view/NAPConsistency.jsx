  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
      <div className="px-6 py-4 border-b border-gray-200">
        <h2 className="text-lg font-semibold text-gray-900">NAP Consistency</h2>
      </div>
      <div className="px-6 py-4 space-y-4">
        {napIssues ? (
          <>
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-900">Name Consistency</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-900">Address Consistency</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-900">Phone Consistency</span>
          ...
          <p className="text-sm text-gray-500">No NAP data available</p>
        )}
      </div>
    </div>
  );
