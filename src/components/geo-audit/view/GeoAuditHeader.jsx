"use client";
import { HiLocationMarker, HiDownload, HiRefresh } from "react-icons/hi";

export default function GeoAuditHeader({ audit, onRerun, onDownloadPDF, isDownloadingPDF }) {
  return (
    <div className="bg-white border-b border-gray-200 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <h1 className="text-2xl font-semibold text-gray-900 mb-2">GEO Audit Results</h1>
