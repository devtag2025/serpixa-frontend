        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <button
              ...
              className="flex items-center gap-2 cursor-pointer px-3 sm:px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium text-xs sm:text-sm shadow-sm whitespace-nowrap"
            >
              {isDownloadingPDF ? (
                <>
