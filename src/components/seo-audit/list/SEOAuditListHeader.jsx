    ...
    <div className="bg-white border-b border-gray-200 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 mb-1">{t("dashboard.seoAudit.list.title")}</h1>
            <p className="text-sm text-gray-600">{t("dashboard.seoAudit.list.subtitle")}</p>
          </div>
          <button
