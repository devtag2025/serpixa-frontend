  ...
  return (
    <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 shadow-sm">
      <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 border-b border-gray-200">
        <h2 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900">{t("dashboard.seoAudit.view.onPageAnalysis")}</h2>
      </div>
      <div className="divide-y divide-gray-200">
        {checks.title && (
          <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex items-start justify-between gap-2 sm:gap-3 lg:gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                <span className="text-xs sm:text-sm font-semibold text-gray-900">{t("dashboard.seoAudit.view.titleTag")}</span>
                {checks.title.exists ? (
            ...
            {checks.title.value && (
              ...
              >
                <HiClipboardCopy className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </button>
            )}
          </div>
        )}
        ...
        {checks.description && (
          <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex items-start justify-between gap-2 sm:gap-3 lg:gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                <span className="text-xs sm:text-sm font-semibold text-gray-900">{t("dashboard.seoAudit.view.metaDescription")}</span>
        ...
        {checks.h1 && (
          <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex items-start justify-between gap-2 sm:gap-3 lg:gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                <span className="text-xs sm:text-sm font-semibold text-gray-900">{t("dashboard.seoAudit.view.h1Tag")}</span>
                {checks.h1.exists ? (
                  <HiCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 flex-shrink-0" />
                ) : (
                  <HiXCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 flex-shrink-0" />
        ...
        {checks.images && (
          <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex items-start justify-between gap-2 sm:gap-3 lg:gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                <span className="text-xs sm:text-sm font-semibold text-gray-900">{t("dashboard.seoAudit.view.images")}</span>
                {checks.images.withoutAlt === 0 ? (
                  <HiCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 flex-shrink-0" />
                ) : (
                  <HiXCircle className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600 flex-shrink-0" />
                )}
              </div>
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 lg:gap-4 text-[10px] sm:text-xs lg:text-sm text-gray-700">
        ...
        {checks.links && (
          <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex items-start justify-between gap-2 sm:gap-3 lg:gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                <span className="text-xs sm:text-sm font-semibold text-gray-900">{t("dashboard.seoAudit.view.links")}</span>
        ...
        {checks.canonical && (
          <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex items-start justify-between gap-2 sm:gap-3 lg:gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                <span className="text-xs sm:text-sm font-semibold text-gray-900">{t("dashboard.seoAudit.view.canonicalTag")}</span>
              ...
              {checks.canonical.value ? (
                <>
                  <p className="text-xs sm:text-sm text-gray-700 mb-2 break-all">
                    {checks.canonical.value}
                  </p>
                  <button
                    onClick={() => onCopyToClipboard(checks.canonical.value, "Canonical URL")}
                    className="text-[10px] sm:text-xs text-primary hover:text-primary/80 transition-colors font-medium flex items-center gap-1"
                  >
                ...
                <p className="text-xs sm:text-sm text-gray-500">{t("dashboard.seoAudit.view.notFound")}</p>
              )}
            </div>
          </div>
        )}
