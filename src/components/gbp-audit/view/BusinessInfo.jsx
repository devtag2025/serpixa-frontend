        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {businessInfo.category && (
            <div className="flex items-start gap-3">
              <HiOfficeBuilding className="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" />
              <div className="flex-1">
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Primary Category</p>
          ...
          {businessInfo.additionalCategories && businessInfo.additionalCategories.length > 0 && (
            <div className="flex items-start gap-3">
              <HiOfficeBuilding className="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" />
              <div className="flex-1">
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Additional Categories</p>
          ...
          {businessInfo.hours && Object.keys(businessInfo.hours).length > 0 && (
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-900">Set</p>
              </div>
            </div>
          )}
