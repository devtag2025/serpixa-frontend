...
export default function GBPAuditListStats({ audits }) {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
      <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-3 sm:p-4 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
          <div className="p-1.5 sm:p-2 rounded-lg bg-blue-50 flex-shrink-0">
            <HiOfficeBuilding className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600" />
          </div>
          <span className="text-[10px] sm:text-xs font-semibold text-gray-500 leading-tight line-clamp-2">{t("dashboard.gbpAudit.list.totalAudits")}</span>
        </div>
      ...
      <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-3 sm:p-4 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
          ...
          <span className="text-[10px] sm:text-xs font-semibold text-gray-500 leading-tight line-clamp-2">{t("dashboard.gbpAudit.list.avgScore")}</span>
        </div>
      ...
      <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-3 sm:p-4 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
          ...
          <span className="text-[10px] sm:text-xs font-semibold text-gray-500 leading-tight line-clamp-2">{t("dashboard.gbpAudit.list.totalRecommendations")}</span>
        </div>
        <p className="text-xl sm:text-2xl font-bold text-gray-900">{totalRecommendations}</p>
      </div>
      ...
      <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-3 sm:p-4 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
          ...
          <span className="text-[10px] sm:text-xs font-semibold text-gray-500 leading-tight line-clamp-2">{t("dashboard.gbpAudit.list.completed")}</span>
        </div>
